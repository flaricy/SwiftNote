...
<key>CFBundleIdentifier</key><string>io.github.flaricy.SwiftNote</string><key>CFBundleExecutable</key><string>LocalNotes</string><key>CFBundleName</key><string>随记</string><key>CFBundleDisplayName</key><string>随记</string><key>CFBundlePackageType</key><string>APPL</string><key>CFBundleVersion</key><string>4</string><key>CFBundleShortVersionString</key><string>1.0.3</string><key>LSMinimumSystemVersion</key><string>14.0</string><key>NSRequiresAquaSystemAppearance</key><true/><key>NSHighResolutionCapable</key><true/><key>NSHumanReadableCopyright</key><string>Copyright © 2026 flaricy. MIT License.</string>
</dict></plist>
PLIST
