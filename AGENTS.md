...
For UI changes, an independent reviewer must inspect real screenshots and the affected interactions before delivery. Cover alignment, typography, spacing, contrast, narrow windows, and the fixed warm-paper appearance under both light and dark system settings. Do not treat a screenshot as proof of interaction behavior.
